  ...
  return (
    <View style={styles.Container}>
      ...
      <View style={styles.lottieWrapper}>
        <LottieView
          source={require('../../assets/Animation - 1728126878969.json')}
      ...
      {/* Step 3: Use Animated.View for sliding-down animation */}
        <Text style={styles.title}>Easily Share Your Progress</Text>
        <Text style={styles.description}>
            Track your progress and share records with healthcare providers or researchers. Your data is at your fingertips, ready when you need it.
        </Text>
      </Animated.View>
